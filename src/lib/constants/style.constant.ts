...
export const INPUT_STYLE = cn(
    ...
    "dark:has-[input:disabled]:border-zinc-700 dark:has-[input:disabled]:[&_svg]:stroke-zinc-600 dark:has-[input:disabled]:bg-background dark:has-[input:disabled]:text-zinc-600 dark:has-[input:disabled]:placeholder:text-zinc-600"
)