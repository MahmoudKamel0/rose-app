...
export const sarabun = localFont({
    src: [
        { path: "../../public/fonts/sarabun/Sarabun-Thin.woff2", weight: "100", style: "normal" },
        { path: "../../public/fonts/sarabun/Sarabun-ExtraLight.woff2", weight: "200", style: "normal" },
        { path: "../../public/fonts/sarabun/Sarabun-Light.woff2", weight: "300", style: "normal" },
        ...
        { path: "../../public/fonts/sarabun/Sarabun-ExtraBold.woff2", weight: "800", style: "normal" },
    ],
...
export const tajawal = localFont({
    src: [
        { path: "../../public/fonts/tajawal/Tajawal-ExtraLight.woff2", weight: "200", style: "normal" },
