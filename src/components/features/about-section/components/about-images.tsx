...
// const secondaryRounded = "rounded-tl-xl rounded-tr-3xl rounded-br-3xl rounded-bl-xl";
...
export default function AboutImages() {
    return (
        <div className="flex gap-2">
            ...
            <MainImage />
            {/* Right Column Images */}
            <div className="otherImages flex max-h-[345px] w-[193px] flex-col gap-2 px-2 py-4">
                <Image
                    src="/images/brown-gift-orange-confetti.webp"
                    alt="Elegant chocolate gift box"
                    width={193}
                    height={193}
                    className="h-[193px] w-[193px] rounded-[150px] object-cover"
                />
                <Image
                    src="/images/gift-card-with-balloons.webp"
                    alt="Luxury red gift box with flowers"
                    width={193}
                    height={144}
