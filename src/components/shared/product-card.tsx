            ...
            <CardContent className={cn("space-y-1.5 px-0 py-5")}>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <p className="text-base font-medium text-maroon-700 dark:text-[#FFC2D0]">{product.priceAfterDiscount} EGP</p>
                    ...
                    <Button
                        size="icon"
                        className={cn("flex h-10 w-10 items-center justify-center rounded-full bg-maroon-600 leading-none text-white")}
                    >
                        <ShoppingCart
